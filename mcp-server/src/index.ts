    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error reading directory: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error searching files: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
...
server.registerTool(
  ...
  async ({ path: filePath, encoding, maxSize }) => {
    ...
    try {
      ...
      const content = await fs.readFile(resolved, encoding as "utf-8" | "ascii" | "base64" | "hex");
      return {
        content: [
          {
            type: "text",
...
server.registerTool(
  ...
  async ({ path: filePath, content, encoding }) => {
    ...
    try {
      ...
      await fs.writeFile(resolved, content, encoding as "utf-8" | "ascii" | "base64" | "hex");
      const meta = await getFileMeta(resolved);
      return {
        content: [
          {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error deleting: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error creating directory: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error renaming/moving: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error copying: ${(err as Error).message}`,
          },
        ],
        isError: true,
      };
